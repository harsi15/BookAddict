...
import 'package:grocerey_shopping/models/cart.dart';
import 'package:grocerey_shopping/razorpay/main.dart';
import 'package:grocerey_shopping/screens/cart/components/body.dart';
          ...
          children: [
            Row(
              children: [
                ...
                Spacer(),
                // here the width of the box is fixed so that's why const is used
